...
public class IdentityBasicAuthenticationAttribute : BasicAuthenticationAttribute
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        cancellationToken
            .ThrowIfCancellationRequested(); // Unfortunately, UserManager doesn't support CancellationTokens.
        ...
        // identity = await userManager.ClaimsIdentityFactory.CreateAsync(userManager, user, "Basic");
